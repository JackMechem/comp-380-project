					...
					return (
						...
						>
							...
							<div className="px-[10px] py-[8px]">
								...
								<p className="text-foreground-light text-[8.5pt]">
									{car.modelYear}
								</p>
...
const CarFormPanel = ({ mode }: CarFormPanelProps) => {
	...
	useEffect(() => {
		if (selectedVin) {
			getCar(selectedVin)
				.then((car) => setForm(car))
				.catch(console.error);
		} else if (
			selectedVin === null &&
			Object.keys(form).length > Object.keys(BLANK).length
		) {
			setForm(BLANK);
		}
	}, [selectedVin]);
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-[12px]">
							...
							<Field label="Year">
								<input
									...
									value={numVal("modelYear")}
									onChange={(e) => handleNum("modelYear", e.target.value)}
								/>
							</Field>
						</div>
					</SectionCard>
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-[12px]">
							<Field label="Price / Day ($)">
								<input
									...
									className={inputCls}
									placeholder="e.g. 299"
									value={numVal("pricePerDay")}
									onChange={(e) => handleNum("pricePerDay", e.target.value)}
								/>
							</Field>
							<Field label="MPG">
								<input
									...
									placeholder="e.g. 30"
									value={numVal("mpg")}
									onChange={(e) => handleNum("mpg", e.target.value)}
								/>
							</Field>
							<Field label="Seats">
								<input
									...
									placeholder="e.g. 4"
									value={numVal("seats")}
									onChange={(e) => handleNum("seats", e.target.value)}
								/>
							</Field>
							<Field label="Fuel">
								<select
									className={selectCls}
									value={form.fuel ?? "GASOLINE"}
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-[12px]">
							<Field label="Horsepower (hp)">
								<input
									...
									className={inputCls}
									placeholder="e.g. 500"
									value={numVal("horsepower")}
									onChange={(e) => handleNum("horsepower", e.target.value)}
								/>
							</Field>
							<Field label="Torque (lb-ft)">
								<input
									...
									placeholder="e.g. 450"
									value={numVal("torque")}
									onChange={(e) => handleNum("torque", e.target.value)}
								/>
							</Field>
							<Field label="Cylinders">
								<input
									...
									className={inputCls}
									placeholder="e.g. 6"
									value={numVal("cylinders")}
									onChange={(e) => handleNum("cylinders", e.target.value)}
								/>
							</Field>
							<Field label="Gears">
								<input
									...
									placeholder="e.g. 8"
									value={numVal("gears")}
									onChange={(e) => handleNum("gears", e.target.value)}
								/>
							</Field>
						</div>
					</SectionCard>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-[16px]">
						...
						<SectionCard title="Classification">
							...
							<Field label="Vehicle Class">
								<select
									className={selectCls}
									value={form.vehicleClass ?? "LUXURY"}
